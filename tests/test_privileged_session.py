...
Changelog: Verify that the session broker accepts only NetCheck VLAN workers.
"""
...
def test_allows_only_vlan_workers_from_the_current_executable() -> None:
    ...
    assert not _command_is_allowed((sys.executable, main_script, "--neighbor-worker", "en0"))
