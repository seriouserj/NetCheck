...
Changelog: Document the unified navy and cyan button palette in v1.6.10.
-->
...
```shell
shasum -a 256 -c NetCheck-1.6.10-macos-x86_64.zip.sha256
ditto -x -k NetCheck-1.6.10-macos-x86_64.zip .
