...
- `dist/NetCheck-1.9.0-macos-x86_64.zip`
- `dist/NetCheck-1.9.0-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.9.0-windows-x86_64.zip`
- `dist/NetCheck-1.9.0-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.9.0 -m "NetCheck v1.9.0"
