...
Changelog: Document release 1.9.9 artifact names.
-->
...
- `dist/NetCheck-1.9.9-macos-x86_64.zip`
- `dist/NetCheck-1.9.9-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.9.9-windows-x86_64.zip`
- `dist/NetCheck-1.9.9-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.9.9 -m "NetCheck v1.9.9"
