...
Changelog: Document release 1.9.7 artifact names.
-->
...
- `dist/NetCheck-1.9.7-macos-x86_64.zip`
- `dist/NetCheck-1.9.7-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.9.7-windows-x86_64.zip`
- `dist/NetCheck-1.9.7-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.9.7 -m "NetCheck v1.9.7"
