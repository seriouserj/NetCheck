...
Changelog: Update reproducible build and artifact examples for v1.5.0.
-->
...
- `dist/NetCheck-1.5.0-macos-x86_64.zip`
- `dist/NetCheck-1.5.0-macos-x86_64.zip.sha256`
...
```shell
git tag -a v1.5.0 -m "NetCheck v1.5.0"
