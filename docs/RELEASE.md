...
- `dist/NetCheck-1.8.1-macos-x86_64.zip`
- `dist/NetCheck-1.8.1-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.8.1-windows-x86_64.zip`
- `dist/NetCheck-1.8.1-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.8.1 -m "NetCheck v1.8.1"
