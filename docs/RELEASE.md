...
- `dist/NetCheck-1.8.3-macos-x86_64.zip`
- `dist/NetCheck-1.8.3-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.8.3-windows-x86_64.zip`
- `dist/NetCheck-1.8.3-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.8.3 -m "NetCheck v1.8.3"
