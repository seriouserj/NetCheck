...
Changelog: Update reproducible build and artifact examples for v1.6.4.
-->
...
- `dist/NetCheck-1.6.4-macos-x86_64.zip`
- `dist/NetCheck-1.6.4-macos-x86_64.zip.sha256`
...
```shell
git tag -a v1.6.4 -m "NetCheck v1.6.4"
