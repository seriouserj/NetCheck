...
Changelog: Document reproducible macOS builds, signing, artifacts, and tagged releases.
-->
...
- `dist/NetCheck-1.0.0-macos-x86_64.zip`
- `dist/NetCheck-1.0.0-macos-x86_64.zip.sha256`
...
```shell
git tag -a v1.0.0 -m "NetCheck v1.0.0"
