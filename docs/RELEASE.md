...
Changelog: Update reproducible build and artifact examples for v1.3.1.
-->
...
- `dist/NetCheck-1.3.1-macos-x86_64.zip`
- `dist/NetCheck-1.3.1-macos-x86_64.zip.sha256`
...
```shell
git tag -a v1.3.1 -m "NetCheck v1.3.1"
