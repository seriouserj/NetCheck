...
Changelog: Document release 1.10.0 artifact names.
-->
...
- `dist/NetCheck-1.10.0-macos-x86_64.zip`
- `dist/NetCheck-1.10.0-macos-x86_64.zip.sha256`
...
- `dist/NetCheck-1.10.0-windows-x86_64.zip`
- `dist/NetCheck-1.10.0-windows-x86_64.zip.sha256`
...
```shell
git tag -a v1.10.0 -m "NetCheck v1.10.0"
